...
azureTicketsApp.factory('formService',
    [
        ...
        function($q, $rootScope, modelService, configService, $q, $timeout) {
          ...
          /**
           * The deferred object always resolve, passing true when no error or
           * an object similar to this when there is an error:
           * 
          ...
          var _wizard = {
            renderError : function(e, err) {
              ...
              var cs = !angular.isDefined(addr) ? jQuery(e).parents('dl')
                  .first().parent('div[collapse]') : jQuery(e).parents(
