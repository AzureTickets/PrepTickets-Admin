var ScannerResources = {
  ...
  Text_ActiveDevice : 'Are you sure want to activate this device?',
  Text_DeactiveDevice : 'Are you sure want to deactivate this device?',
  Text_UnregisterDevice : 'Are you sure want to unregister device?',
  Text_UpdateDevice : 'Are you sure want to update this device?',
  Text_RemoveDevice : 'Are you sure want to remove this device?',
