...
var CommonResources = {
  ...
  Text_ThisNameInUsed : 'This name is already in use!',
  ...
  Text_BackToCategoryList : 'Back to category list',
  Text_BackToVenueList : 'Back to venue list',
  Text_BackToScannerList : 'Back to scanner list',
  Text_EmptyList : 'The list is empty',
  Text_CategoryMenu_Categories : 'Categories',
  Text_NoCategory_Msg : 'Empty category list',
  Text_CategoryMenu_CreateCategory : 'Add Category',
  ...
  Text_MainNoParent : 'Main (no parent)',
  Text_SchoolInfo : 'School Info',
  LabelCategoryName : 'Category Name',
  LabelCategoryBrief : 'Brief Description',
  LabelCategoryDescription : 'Category Full Description',
  Text_Pending_Approvals : 'Pending Approvals',
  Text_Approval : 'Approval',
  Text_Type : 'Type',
  Text_Approve : 'Approve',
  Text_MissingURI : 'The URI for this School is missing',
  Text_Reject : 'Reject',
  ...
  Text_Create : 'Create',
  Text_CreateandClose : 'Create and Close',
  Text_Change : 'Change',
  Text_Color : 'Color',
  Text_Agreement : 'Service Agreement',
  Text_Add : 'Add',
  Text_Save : 'Save',
  Text_SaveandClose : 'Save and Close',
  ...
  Text_View : 'View',
  Text_List : 'List',
  Text_SchoolList : 'My Schools',
  Text_SchoolListMenu : 'Your Schools',
  Text_Grid : 'Grid',
  Text_Ticket : 'Ticket',
  Text_SortBy : 'Sort by',
  ...
  Text_School_Catalog : 'School Catalog',
  Text_Choose : 'Choose',
  Text_ChooseOption : 'Choose option...',
  Text_SendRequest : 'Submit Request',
  Text_RequestAccess : 'Request Access',
  ...
  Text_SelectSchoolPreRegister : 'Choose this school',
  Text_SchoolPreRegister : 'Register School',
  Text_SchoolPreRegister_Desc : 'Find your school',
  Text_SchoolPreRegister_Step1 : 'School Search',
  Text_SchoolPreRegister_Step2 : 'School Selection',
  Text_WizardRequestComplete : 'Your school pre-registration request has been sent. Please wait while we process your information.',
  Text_ID : 'ID',
  Text_Profile : 'Profile',
  Text_School : 'School',
  Text_SchoolName : 'School Name',
  Text_SchoolType : 'Your School',
  Text_SchoolCurrency : 'Currency',
  LabelCartCurrency : 'Currency',
  ...
  LabelPricingTierOnSaleDateTimeStart : 'Sales Start On',
  LabelPricingTierOnSaleDateTimeEnd : 'Sales End On',
  LabelPricingTierStock : 'Stock Available',
  LabelEventMaximumCapacity : 'Maximum Capacity',
  LabelGeneralAdmissionTicketItemInfoStock : 'Stock',
  Text_SchoolMenu_SchoolDetailBt : 'School Details',
  Text_SchoolMenu_Categories : 'Categories',
  Text_SchoolMenu_CreateCate : 'Create Category',
  Text_SchoolMenu_CreateSubCate : 'Create Sub Category',
  Text_SchoolMenu_PaymentSettings : 'Payment Settings',
  Text_SchoolMenu_Provider : 'Social Network Providers',
  Text_SchoolMenu_PaymentProvider : 'Payment Providers',
  Text_SchoolMenu_AddPaymentProvider : 'Add Payment Providers',
  Text_MediaLibraryMenu_MediaLibrary : 'Media',
  Text_EventMenu_AddImage : 'Add Image',
  ...
  Text_VenueEmpty : 'No venues were found for your school',
  ...
  Text_ConfirmCreate : 'Please review your information, click Create to create your',
  ...
  Text_PublicSchool : 'Are you sure you want to make this school public?',
  Text_PrivateSchool : 'Are you sure you want to make this school private?',
  ...
  Text_ChooseSchoolThumbImage : 'Are you sure you would like to replace the current image?',
  ...
  Text_Today : 'Today',
  Text_Last1Days : 'Last 24 Hours',
  Text_Last7Days : 'Last 7 Days',
  Text_Last30Days : 'Last 30 Days',
  Text_Last60Days : 'Last 60 Days',
  ...
  Text_Custom : 'Custom',
  Text_SchoolOrders : 'School\'s Orders',
  ...
  Text_Event : "Event",
  Text_Venue : 'Venue',
  Text_VenueName : 'Venue Name',
  Text_VenueInformation : 'Venue Information',
  Text_Date : "Date",
  ...
  Text_WaitLoadingShoolData : 'Loading school data, please wait...',
  ...
  Text_NoVenueMsg : "Currently there are no venues for this school.",
  ...
  Text_CreateSchool : "Create School",
  Text_CreateSchool_Step1 : "Step 1: Information",
  Text_CreateSchool_Step2 : "Step 2: Location",
  Text_CreateSchool_Step3 : "Step 3: Picture",
  Text_CreateSchool_Step4 : "Step 4: Accounting",
  ...
  Text_Scanner : "Scan Device",
  Text_OSVersion : "OS Version",
  Text_Lastsyncdate : "LastSyncDate",
  Text_ATsVersion : "ATs Version",
  Text_NoScanDevice : "Currently there are no scan devices for this school.",
  Text_NoImageSelected : 'No Picture',
  Text_ImageSelect : 'Picture Selector',
  ...
  Text_Completed_Description : "Thank you for creating your school, we will now take you to your school where you can continue to customize and add events and tickets.",
